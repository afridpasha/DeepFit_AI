...
class MongoDBManager:
    ...
    def store_height_weight_instance(self, data, user_email):
        ...
        try:
            ...
            normalized_email = str(user_email).strip().lower() if user_email else "anonymous@deepfit.local"
            
            document = {
                "user_email": normalized_email,
                "email": normalized_email,  # Store in both fields for compatibility
            ...
            print(f"✅ Stored measurement for {normalized_email} - ID: {result.inserted_id}")
    ...
    def store_final_estimate(self, data, user_email):
        ...
        try:
            ...
            print(f"✅ Stored final estimate for {normalized_email} - ID: {result.inserted_id}")
            return result.inserted_id
        except Exception as e:
